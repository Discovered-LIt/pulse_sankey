  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50">
      ...
      <div className='z-50 bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 rounded text-black relative'>
        ...
        {primaryButton && <div className="flex justify-end gap-2 pt-4">
          {primaryButton && <button
            type="button"
            disabled={primaryButton.disabled}
            className={cn([
              "inline-flex w-full justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm sm:ml-3 sm:w-auto",
              !primaryButton?.disabled ? "hover:bg-blue-500 bg-blue-600" : "pointer-events-none cursor-not-allowed bg-gray-300"
            ])}
