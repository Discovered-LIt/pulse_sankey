import { SankeyCategory, sankeySettings, RED, LIGHT_GREEN, LIGHT_RED, GREEN, GREY, LIGHT_GREY } from "../config/sankey";

export const getSankeyDisplayColor = (value: number, type: SankeyCategory): { lite: string, dark: string } => {
