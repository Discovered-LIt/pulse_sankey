...
const items: {[key in Types]: Item[]} = {
  [Types.COMPANIES]: [
    ...
    { label: '', logo: 'https://pulse-stockprice.s3.us-east-2.amazonaws.com/Logos/ferrarilogo.svg', url: '/data', param:'ferrari' },
    { label: '', logo: 'https://pulse-stockprice.s3.us-east-2.amazonaws.com/Logos/uberlong.svg', url: '/data', param:'uber' },
    { label: '', logo: 'https://pulse-stockprice.s3.us-east-2.amazonaws.com/Logos/lvmhlogo.svg', url: '/data', param:'lvmh' },
